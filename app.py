...
page_header(
    ...
    "Transaction-level fraud analysis, model evaluation, and confidence-aware decision support.",
)
st.info("Use the sidebar to open the executive overview, explore fraud patterns, review model development and performance, validate confidence, or score a validation transaction.")
...
with cols[2]:
    concept_card("Decide", "Separate fraud score from prediction confidence and inspect the evidence supporting each decision.", "#b7791f")

st.subheader("Frozen inference architecture")
flow_diagram(["Raw transaction", "Saved preprocessor", "57 selected features", "Random Forest", "Frozen threshold", "Confidence model"])
